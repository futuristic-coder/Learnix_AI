    ...
    return (
      <div className="max-w-4xl mx-auto">
        <button
          ...
          className="inline-flex items-center gap-2 mb-6 px-4 py-2 text-gray-600 hover:text-gray-800 hover:bg-white rounded-lg transition-all duration-200 font-medium"
        >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Flashcard Set</h2>
            <p className="text-gray-600">Review your cards one by one</p>
          </div>
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {flashcardSets.map((set) => (
            ...
            >
              <button
                ...
                className="absolute top-3 right-3 z-10 p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200 opacity-0 group-hover:opacity-100"
              >
