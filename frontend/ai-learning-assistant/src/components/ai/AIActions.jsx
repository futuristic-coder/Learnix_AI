            ...
            <form onSubmit={handleExplainConcept} className="h-full flex flex-col">
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900">Explain a Concept</h4>
                  <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="flex-1 flex flex-col gap-3 mt-4">
                <div>
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors duration-200"
                  />
                </div>
                <button
                  type="submit"
