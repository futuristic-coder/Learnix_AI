    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6">
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-8 text-center max-w-md">
          <p className="text-slate-700 dark:text-slate-300 text-lg">Quiz not found or has no questions.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-8 mb-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-lg font-semibold text-slate-900 dark:text-slate-100">Question {currentQuestionIndex + 1}</span>
          </div>
          <h3 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6 leading-relaxed">{currentQuestion.question}</h3>
              ...
              <label
                ...
                className={`flex items-center gap-4 p-5 border-2 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-md ${
                  isSelected 
                    ...
                    : "bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-600 hover:border-indigo-300 dark:hover:border-indigo-400"
                }`}
              >
                <input
                  type="radio"
